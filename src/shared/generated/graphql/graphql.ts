...
export type CreateChatInputMutation = { __typename?: 'Mutation', createChat: { __typename?: 'Chat', _id: string, name?: string | null, isPrivate: boolean, userIds: Array<string>, userId: string } };
...
export type GetMessagesQuery = { __typename?: 'Query', messages: Array<{ __typename?: 'Message', _id: string, content: string, createdAt: any, userId: string, chatId: string }> };
...
export type CurrentUserQuery = { __typename?: 'Query', currentUser: { __typename?: 'User', _id: string, email: string } };
